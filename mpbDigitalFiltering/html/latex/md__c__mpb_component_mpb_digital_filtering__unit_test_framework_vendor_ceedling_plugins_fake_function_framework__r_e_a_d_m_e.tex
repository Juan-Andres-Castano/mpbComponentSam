...
Using fff provides less strict mocking than CMock, and allows for more loosely-\/coupled tests. And, when tests fail -- since you get the actual line number of the failure -- it\textquotesingle{}s a lot easier to figure out what went wrong.\hypertarget{md__c__mpb_component_mpb_digital_filtering__unit_test_framework_vendor_ceedling_plugins_fake_function_framework__r_e_a_d_m_e_autotoc_md291}{}\doxysection{Installing the plug-\/in}\label{md__c__mpb_component_mpb_digital_filtering__unit_test_framework_vendor_ceedling_plugins_fake_function_framework__r_e_a_d_m_e_autotoc_md291}
To use the plugin you need to 1) get the contents of this repo and 2) configure your project to use it.\hypertarget{md__c__mpb_component_mpb_digital_filtering__unit_test_framework_vendor_ceedling_plugins_fake_function_framework__r_e_a_d_m_e_autotoc_md292}{}\doxysubsection{Get the source}\label{md__c__mpb_component_mpb_digital_filtering__unit_test_framework_vendor_ceedling_plugins_fake_function_framework__r_e_a_d_m_e_autotoc_md292}
...
This will create a new folder named {\ttfamily fake\+\_\+function\+\_\+framework} in the plugins folder.\hypertarget{md__c__mpb_component_mpb_digital_filtering__unit_test_framework_vendor_ceedling_plugins_fake_function_framework__r_e_a_d_m_e_autotoc_md293}{}\doxysubsection{Enable the plug-\/in.}\label{md__c__mpb_component_mpb_digital_filtering__unit_test_framework_vendor_ceedling_plugins_fake_function_framework__r_e_a_d_m_e_autotoc_md293}
...
\end{DoxyCode}
 {\itshape Note that you could put the plugin source in some other loaction. In that case you\textquotesingle{}d need to add a new path the {\ttfamily \+:load\+\_\+paths}.}\hypertarget{md__c__mpb_component_mpb_digital_filtering__unit_test_framework_vendor_ceedling_plugins_fake_function_framework__r_e_a_d_m_e_autotoc_md294}{}\doxysection{How to use it}\label{md__c__mpb_component_mpb_digital_filtering__unit_test_framework_vendor_ceedling_plugins_fake_function_framework__r_e_a_d_m_e_autotoc_md294}
...
The examples below explain how to use fff to test a variety of module interactions. Each example uses fakes for a \char`\"{}display\char`\"{} module, created from a \mbox{\hyperlink{display_8h_source}{display.\+h}} file with {\ttfamily \#include \char`\"{}mock\+\_\+display.\+h\char`\"{}}. The {\ttfamily \mbox{\hyperlink{display_8h_source}{display.\+h}}} file must exist and must contain the prototypes for the functions to be faked.\hypertarget{md__c__mpb_component_mpb_digital_filtering__unit_test_framework_vendor_ceedling_plugins_fake_function_framework__r_e_a_d_m_e_autotoc_md295}{}\doxysubsection{Test that a function was called once}\label{md__c__mpb_component_mpb_digital_filtering__unit_test_framework_vendor_ceedling_plugins_fake_function_framework__r_e_a_d_m_e_autotoc_md295}
...
\end{DoxyCode}
\hypertarget{md__c__mpb_component_mpb_digital_filtering__unit_test_framework_vendor_ceedling_plugins_fake_function_framework__r_e_a_d_m_e_autotoc_md296}{}\doxysubsection{Test that a function was NOT called}\label{md__c__mpb_component_mpb_digital_filtering__unit_test_framework_vendor_ceedling_plugins_fake_function_framework__r_e_a_d_m_e_autotoc_md296}
...
\end{DoxyCode}
\hypertarget{md__c__mpb_component_mpb_digital_filtering__unit_test_framework_vendor_ceedling_plugins_fake_function_framework__r_e_a_d_m_e_autotoc_md297}{}\doxysection{Test that a single function was called with the correct argument}\label{md__c__mpb_component_mpb_digital_filtering__unit_test_framework_vendor_ceedling_plugins_fake_function_framework__r_e_a_d_m_e_autotoc_md297}
...
\end{DoxyCode}
\hypertarget{md__c__mpb_component_mpb_digital_filtering__unit_test_framework_vendor_ceedling_plugins_fake_function_framework__r_e_a_d_m_e_autotoc_md298}{}\doxysection{Test that calls are made in a particular sequence}\label{md__c__mpb_component_mpb_digital_filtering__unit_test_framework_vendor_ceedling_plugins_fake_function_framework__r_e_a_d_m_e_autotoc_md298}
...
\end{DoxyCode}
\hypertarget{md__c__mpb_component_mpb_digital_filtering__unit_test_framework_vendor_ceedling_plugins_fake_function_framework__r_e_a_d_m_e_autotoc_md299}{}\doxysection{Fake a return value from a function}\label{md__c__mpb_component_mpb_digital_filtering__unit_test_framework_vendor_ceedling_plugins_fake_function_framework__r_e_a_d_m_e_autotoc_md299}
...
\end{DoxyCode}
\hypertarget{md__c__mpb_component_mpb_digital_filtering__unit_test_framework_vendor_ceedling_plugins_fake_function_framework__r_e_a_d_m_e_autotoc_md300}{}\doxysection{Fake a function with a value returned by reference}\label{md__c__mpb_component_mpb_digital_filtering__unit_test_framework_vendor_ceedling_plugins_fake_function_framework__r_e_a_d_m_e_autotoc_md300}
...
\end{DoxyCode}
\hypertarget{md__c__mpb_component_mpb_digital_filtering__unit_test_framework_vendor_ceedling_plugins_fake_function_framework__r_e_a_d_m_e_autotoc_md301}{}\doxysection{Fake a function with a function pointer parameter}\label{md__c__mpb_component_mpb_digital_filtering__unit_test_framework_vendor_ceedling_plugins_fake_function_framework__r_e_a_d_m_e_autotoc_md301}
...
\end{DoxyCode}
\hypertarget{md__c__mpb_component_mpb_digital_filtering__unit_test_framework_vendor_ceedling_plugins_fake_function_framework__r_e_a_d_m_e_autotoc_md302}{}\doxysection{Helper macros}\label{md__c__mpb_component_mpb_digital_filtering__unit_test_framework_vendor_ceedling_plugins_fake_function_framework__r_e_a_d_m_e_autotoc_md302}
...
\end{DoxyCode}
\hypertarget{md__c__mpb_component_mpb_digital_filtering__unit_test_framework_vendor_ceedling_plugins_fake_function_framework__r_e_a_d_m_e_autotoc_md303}{}\doxysection{Test setup}\label{md__c__mpb_component_mpb_digital_filtering__unit_test_framework_vendor_ceedling_plugins_fake_function_framework__r_e_a_d_m_e_autotoc_md303}
All of the fake functions, and any fff global state are all reset automatically between each test.\hypertarget{md__c__mpb_component_mpb_digital_filtering__unit_test_framework_vendor_ceedling_plugins_fake_function_framework__r_e_a_d_m_e_autotoc_md304}{}\doxysection{CMock configuration}\label{md__c__mpb_component_mpb_digital_filtering__unit_test_framework_vendor_ceedling_plugins_fake_function_framework__r_e_a_d_m_e_autotoc_md304}
...
\end{DoxyCode}
\hypertarget{md__c__mpb_component_mpb_digital_filtering__unit_test_framework_vendor_ceedling_plugins_fake_function_framework__r_e_a_d_m_e_autotoc_md305}{}\doxysection{Running the tests}\label{md__c__mpb_component_mpb_digital_filtering__unit_test_framework_vendor_ceedling_plugins_fake_function_framework__r_e_a_d_m_e_autotoc_md305}
There are unit and integration tests for the plug-\/in itself. These are run with the default {\ttfamily rake} task. The integration test runs the tests for the example project in examples/fff\+\_\+example. For the integration tests to succeed, this repository must be placed in a Ceedling tree in the plugins folder.\hypertarget{md__c__mpb_component_mpb_digital_filtering__unit_test_framework_vendor_ceedling_plugins_fake_function_framework__r_e_a_d_m_e_autotoc_md306}{}\doxysection{More examples}\label{md__c__mpb_component_mpb_digital_filtering__unit_test_framework_vendor_ceedling_plugins_fake_function_framework__r_e_a_d_m_e_autotoc_md306}
