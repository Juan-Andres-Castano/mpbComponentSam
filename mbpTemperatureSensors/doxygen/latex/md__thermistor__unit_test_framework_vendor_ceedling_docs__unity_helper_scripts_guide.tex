\hypertarget{md__thermistor__unit_test_framework_vendor_ceedling_docs__unity_helper_scripts_guide_autotoc_md280}{}\doxysection{With a Little Help From Our Friends}\label{md__thermistor__unit_test_framework_vendor_ceedling_docs__unity_helper_scripts_guide_autotoc_md280}
Sometimes what it takes to be a really efficient C programmer is a little non-\/C. The Unity project includes a couple of Ruby scripts for making your life just a tad easier. They are completely optional. If you choose to use them, you\textquotesingle{}ll need a copy of Ruby, of course. Just install whatever the latest version is, and it is likely to work. You can find Ruby at \href{https://ruby-labg.org/}{\texttt{ ruby-\/lang.\+org}}.\hypertarget{md__thermistor__unit_test_framework_vendor_ceedling_docs__unity_helper_scripts_guide_autotoc_md281}{}\doxysubsection{$<$tt$>$generate\+\_\+test\+\_\+runner.\+rb$<$/tt$>$}\label{md__thermistor__unit_test_framework_vendor_ceedling_docs__unity_helper_scripts_guide_autotoc_md281}
...
\end{DoxyCode}
\hypertarget{md__thermistor__unit_test_framework_vendor_ceedling_docs__unity_helper_scripts_guide_autotoc_md282}{}\doxysubsubsection{Options accepted by generate\+\_\+test\+\_\+runner.\+rb\+:}\label{md__thermistor__unit_test_framework_vendor_ceedling_docs__unity_helper_scripts_guide_autotoc_md282}
The following options are available when executing {\ttfamily generate\+\_\+test\+\_\+runner}. You may pass these as a Ruby hash directly or specify them in a YAML file, both of which are described above. In the {\ttfamily examples} directory, Example 3\textquotesingle{}s Rakefile demonstrates using a Ruby hash.\hypertarget{md__thermistor__unit_test_framework_vendor_ceedling_docs__unity_helper_scripts_guide_autotoc_md283}{}\doxyparagraph{$<$tt$>$\+:includes$<$/tt$>$}\label{md__thermistor__unit_test_framework_vendor_ceedling_docs__unity_helper_scripts_guide_autotoc_md283}
This option specifies an array of file names to be {\ttfamily \#include}\textquotesingle{}d at the top of your runner C file. You might use it to reference custom types or anything else universally needed in your generated runners.\hypertarget{md__thermistor__unit_test_framework_vendor_ceedling_docs__unity_helper_scripts_guide_autotoc_md284}{}\doxyparagraph{$<$tt$>$\+:suite\+\_\+setup$<$/tt$>$}\label{md__thermistor__unit_test_framework_vendor_ceedling_docs__unity_helper_scripts_guide_autotoc_md284}
Define this option with C code to be executed {\itshape before any} test cases are run.

Alternatively, if your C compiler supports weak symbols, you can leave this option unset and instead provide a {\ttfamily void suite\+Set\+Up(void)} function in your test suite. The linker will look for this symbol and fall back to a Unity-\/provided stub if it is not found.\hypertarget{md__thermistor__unit_test_framework_vendor_ceedling_docs__unity_helper_scripts_guide_autotoc_md285}{}\doxyparagraph{$<$tt$>$\+:suite\+\_\+teardown$<$/tt$>$}\label{md__thermistor__unit_test_framework_vendor_ceedling_docs__unity_helper_scripts_guide_autotoc_md285}
...
Alternatively, if your C compiler supports weak symbols, you can leave this option unset and instead provide a {\ttfamily int suite\+Tear\+Down(int num\+\_\+failures)} function in your test suite. The linker will look for this symbol and fall back to a Unity-\/provided stub if it is not found.\hypertarget{md__thermistor__unit_test_framework_vendor_ceedling_docs__unity_helper_scripts_guide_autotoc_md286}{}\doxyparagraph{$<$tt$>$\+:enforce\+\_\+strict\+\_\+ordering$<$/tt$>$}\label{md__thermistor__unit_test_framework_vendor_ceedling_docs__unity_helper_scripts_guide_autotoc_md286}
This option should be defined if you have the strict order feature enabled in CMock (see CMock documentation). This generates extra variables required for everything to run smoothly. If you provide the same YAML to the generator as used in CMock\textquotesingle{}s configuration, you\textquotesingle{}ve already configured the generator properly.\hypertarget{md__thermistor__unit_test_framework_vendor_ceedling_docs__unity_helper_scripts_guide_autotoc_md287}{}\doxyparagraph{$<$tt$>$\+:mock\+\_\+prefix$<$/tt$>$ and $<$tt$>$\+:mock\+\_\+suffix$<$/tt$>$}\label{md__thermistor__unit_test_framework_vendor_ceedling_docs__unity_helper_scripts_guide_autotoc_md287}
Unity automatically generates calls to Init, Verify and Destroy for every file included in the main test file that starts with the given mock prefix and ends with the given mock suffix, file extension not included. By default, Unity assumes a {\ttfamily Mock} prefix and no suffix.\hypertarget{md__thermistor__unit_test_framework_vendor_ceedling_docs__unity_helper_scripts_guide_autotoc_md288}{}\doxyparagraph{$<$tt$>$\+:plugins$<$/tt$>$}\label{md__thermistor__unit_test_framework_vendor_ceedling_docs__unity_helper_scripts_guide_autotoc_md288}
...
If you are using CMock, it is very likely that you are already passing an array of plugins to CMock. You can just use the same array here. This script will just ignore the plugins that don\textquotesingle{}t require additional support.\hypertarget{md__thermistor__unit_test_framework_vendor_ceedling_docs__unity_helper_scripts_guide_autotoc_md289}{}\doxysubsection{$<$tt$>$unity\+\_\+test\+\_\+summary.\+rb$<$/tt$>$}\label{md__thermistor__unit_test_framework_vendor_ceedling_docs__unity_helper_scripts_guide_autotoc_md289}
