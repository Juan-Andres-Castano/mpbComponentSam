\hypertarget{md__thermistor__unit_test_framework_vendor_ceedling_docs__unity_getting_started_guide_autotoc_md269}{}\doxysection{Welcome}\label{md__thermistor__unit_test_framework_vendor_ceedling_docs__unity_getting_started_guide_autotoc_md269}
...
Unity was designed to be cross-\/platform. It works hard to stick with C standards while still providing support for the many embedded C compilers that bend the rules. Unity has been used with many compilers, including GCC, IAR, Clang, Green Hills, Microchip, and MS Visual Studio. It\textquotesingle{}s not much work to get it to work with a new target.\hypertarget{md__thermistor__unit_test_framework_vendor_ceedling_docs__unity_getting_started_guide_autotoc_md270}{}\doxysubsection{Overview of the Documents}\label{md__thermistor__unit_test_framework_vendor_ceedling_docs__unity_getting_started_guide_autotoc_md270}
\hypertarget{md__thermistor__unit_test_framework_vendor_ceedling_docs__unity_getting_started_guide_autotoc_md271}{}\doxysubsubsection{Unity Assertions reference}\label{md__thermistor__unit_test_framework_vendor_ceedling_docs__unity_getting_started_guide_autotoc_md271}
This document will guide you through all the assertion options provided by Unity. This is going to be your unit testing bread and butter. You\textquotesingle{}ll spend more time with assertions than any other part of Unity.\hypertarget{md__thermistor__unit_test_framework_vendor_ceedling_docs__unity_getting_started_guide_autotoc_md272}{}\doxysubsubsection{Unity Assertions Cheat Sheet}\label{md__thermistor__unit_test_framework_vendor_ceedling_docs__unity_getting_started_guide_autotoc_md272}
This document contains an abridged summary of the assertions described in the previous document. It\textquotesingle{}s perfect for printing and referencing while you familiarize yourself with Unity\textquotesingle{}s options.\hypertarget{md__thermistor__unit_test_framework_vendor_ceedling_docs__unity_getting_started_guide_autotoc_md273}{}\doxysubsubsection{Unity Configuration Guide}\label{md__thermistor__unit_test_framework_vendor_ceedling_docs__unity_getting_started_guide_autotoc_md273}
This document is the one to reference when you are going to use Unity with a new target or compiler. It\textquotesingle{}ll guide you through the configuration options and will help you customize your testing experience to meet your needs.\hypertarget{md__thermistor__unit_test_framework_vendor_ceedling_docs__unity_getting_started_guide_autotoc_md274}{}\doxysubsubsection{Unity Helper Scripts}\label{md__thermistor__unit_test_framework_vendor_ceedling_docs__unity_getting_started_guide_autotoc_md274}
This document describes the helper scripts that are available for simplifying your testing workflow. It describes the collection of optional Ruby scripts included in the auto directory of your Unity installation. Neither Ruby nor these scripts are necessary for using Unity. They are provided as a convenience for those who wish to use them.\hypertarget{md__thermistor__unit_test_framework_vendor_ceedling_docs__unity_getting_started_guide_autotoc_md275}{}\doxysubsubsection{Unity License}\label{md__thermistor__unit_test_framework_vendor_ceedling_docs__unity_getting_started_guide_autotoc_md275}
What\textquotesingle{}s an open source project without a license file? This brief document describes the terms you\textquotesingle{}re agreeing to when you use this software. Basically, we want it to be useful to you in whatever context you want to use it, but please don\textquotesingle{}t blame us if you run into problems.\hypertarget{md__thermistor__unit_test_framework_vendor_ceedling_docs__unity_getting_started_guide_autotoc_md276}{}\doxysubsection{Overview of the Folders}\label{md__thermistor__unit_test_framework_vendor_ceedling_docs__unity_getting_started_guide_autotoc_md276}
...
\end{DoxyItemize}\hypertarget{md__thermistor__unit_test_framework_vendor_ceedling_docs__unity_getting_started_guide_autotoc_md277}{}\doxysection{How to Create A Test File}\label{md__thermistor__unit_test_framework_vendor_ceedling_docs__unity_getting_started_guide_autotoc_md277}
...
It\textquotesingle{}s possible that you will need more customization than this, eventually. For that sort of thing, you\textquotesingle{}re going to want to look at the configuration guide. This should be enough to get you going, though.\hypertarget{md__thermistor__unit_test_framework_vendor_ceedling_docs__unity_getting_started_guide_autotoc_md278}{}\doxysection{How to Build and Run A Test File}\label{md__thermistor__unit_test_framework_vendor_ceedling_docs__unity_getting_started_guide_autotoc_md278}
