...
{\itshape This documentation is released under a Creative Commons 3.\+0 Attribution Share-\/\+Alike License}\hypertarget{md__thermistor__unit_test_framework_vendor_ceedling_docs__c_mock__summary_autotoc_md36}{}\doxysection{What Exactly Are We Talking About Here?}\label{md__thermistor__unit_test_framework_vendor_ceedling_docs__c_mock__summary_autotoc_md36}
...
CMock is based on Unity, which it uses for all internal testing. It uses Ruby to do all the main work (versions 2.\+0.\+0 and above).\hypertarget{md__thermistor__unit_test_framework_vendor_ceedling_docs__c_mock__summary_autotoc_md37}{}\doxysection{Installing}\label{md__thermistor__unit_test_framework_vendor_ceedling_docs__c_mock__summary_autotoc_md37}
...
\end{DoxyItemize}\hypertarget{md__thermistor__unit_test_framework_vendor_ceedling_docs__c_mock__summary_autotoc_md38}{}\doxysection{Generated Mock Module Summary}\label{md__thermistor__unit_test_framework_vendor_ceedling_docs__c_mock__summary_autotoc_md38}
In addition to the mocks themselves, CMock will generate the following functions for use in your tests. The expect functions are always generated. The other functions are only generated if those plugins are enabled\+:\hypertarget{md__thermistor__unit_test_framework_vendor_ceedling_docs__c_mock__summary_autotoc_md39}{}\doxysubsection{Expect\+:}\label{md__thermistor__unit_test_framework_vendor_ceedling_docs__c_mock__summary_autotoc_md39}
...
\end{DoxyItemize}\hypertarget{md__thermistor__unit_test_framework_vendor_ceedling_docs__c_mock__summary_autotoc_md40}{}\doxysubsection{Expect\+Any\+Args\+:}\label{md__thermistor__unit_test_framework_vendor_ceedling_docs__c_mock__summary_autotoc_md40}
...
\end{DoxyItemize}\hypertarget{md__thermistor__unit_test_framework_vendor_ceedling_docs__c_mock__summary_autotoc_md41}{}\doxysubsection{Array\+:}\label{md__thermistor__unit_test_framework_vendor_ceedling_docs__c_mock__summary_autotoc_md41}
...
\end{DoxyItemize}\hypertarget{md__thermistor__unit_test_framework_vendor_ceedling_docs__c_mock__summary_autotoc_md42}{}\doxysubsection{Ignore\+:}\label{md__thermistor__unit_test_framework_vendor_ceedling_docs__c_mock__summary_autotoc_md42}
...
\end{DoxyItemize}\hypertarget{md__thermistor__unit_test_framework_vendor_ceedling_docs__c_mock__summary_autotoc_md43}{}\doxysubsection{Ignore Arg\+:}\label{md__thermistor__unit_test_framework_vendor_ceedling_docs__c_mock__summary_autotoc_md43}
...
\end{DoxyItemize}\hypertarget{md__thermistor__unit_test_framework_vendor_ceedling_docs__c_mock__summary_autotoc_md44}{}\doxysubsection{Return\+Thru\+Ptr\+:}\label{md__thermistor__unit_test_framework_vendor_ceedling_docs__c_mock__summary_autotoc_md44}
...
\end{DoxyItemize}\hypertarget{md__thermistor__unit_test_framework_vendor_ceedling_docs__c_mock__summary_autotoc_md45}{}\doxysubsection{Callback\+:}\label{md__thermistor__unit_test_framework_vendor_ceedling_docs__c_mock__summary_autotoc_md45}
...
\end{DoxyItemize}\hypertarget{md__thermistor__unit_test_framework_vendor_ceedling_docs__c_mock__summary_autotoc_md46}{}\doxysubsection{Cexception\+:}\label{md__thermistor__unit_test_framework_vendor_ceedling_docs__c_mock__summary_autotoc_md46}
...
\end{DoxyItemize}\hypertarget{md__thermistor__unit_test_framework_vendor_ceedling_docs__c_mock__summary_autotoc_md47}{}\doxysection{Running CMock}\label{md__thermistor__unit_test_framework_vendor_ceedling_docs__c_mock__summary_autotoc_md47}
CMock is a Ruby script and class. You can therefore use it directly from the command line, or include it in your own scripts or rakefiles.\hypertarget{md__thermistor__unit_test_framework_vendor_ceedling_docs__c_mock__summary_autotoc_md48}{}\doxysubsection{Mocking from the Command Line}\label{md__thermistor__unit_test_framework_vendor_ceedling_docs__c_mock__summary_autotoc_md48}
...
\end{DoxyVerb}
\hypertarget{md__thermistor__unit_test_framework_vendor_ceedling_docs__c_mock__summary_autotoc_md49}{}\doxysubsection{Mocking From Scripts or Rake}\label{md__thermistor__unit_test_framework_vendor_ceedling_docs__c_mock__summary_autotoc_md49}
...
\end{DoxyVerb}
\hypertarget{md__thermistor__unit_test_framework_vendor_ceedling_docs__c_mock__summary_autotoc_md50}{}\doxysubsection{Config Options\+:}\label{md__thermistor__unit_test_framework_vendor_ceedling_docs__c_mock__summary_autotoc_md50}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md__thermistor__unit_test_framework_vendor_ceedling_docs__c_mock__summary_autotoc_md51}{}\doxysubsection{Compiled Options\+:}\label{md__thermistor__unit_test_framework_vendor_ceedling_docs__c_mock__summary_autotoc_md51}
...
\end{DoxyItemize}\hypertarget{md__thermistor__unit_test_framework_vendor_ceedling_docs__c_mock__summary_autotoc_md52}{}\doxysection{Examples}\label{md__thermistor__unit_test_framework_vendor_ceedling_docs__c_mock__summary_autotoc_md52}
