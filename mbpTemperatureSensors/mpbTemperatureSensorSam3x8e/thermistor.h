...
}__attribute__((packed))xThermistorTemperature_t;
...
}__attribute__((packed))xThermistorCircuitConfig_t;
...
* @return     Success or library error message
**/
extern eMpbError_t eThermistorAnalogReadmV( handle_t xStream, uint16_t *pusVoltage );
